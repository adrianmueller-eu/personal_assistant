...
function run_bot($update, $user_config_manager, $telegram, $llm, $telegram_admin, $global_config_manager, $is_admin, $DEBUG) {
    ...
    if (is_string($message) && substr($message, 0, 1) == "/") {
        ...
        $shortcuts_medium = array(
            ...
            "/gpt56terra" => "openai/gpt-5.6-terra",                 #         2.50/15.00
        ...
        $shortcuts_large = array(
            ...
            "/gpt56sol" => "openai/gpt-5.6-sol",                   #            5.00/30.00
        ...
        $shortcuts_small = array(
            "/qwen37flash" => "qwen/qwen3.7-flash",              #           0.03/0.13
            ...
            "/gpt56luna" => "openai/gpt-5.6-luna",               #           0.50/3.00
            ...
            "/geminiflash35lite" => "google/gemini-3.5-flash-lite", #        0.30/2.50
